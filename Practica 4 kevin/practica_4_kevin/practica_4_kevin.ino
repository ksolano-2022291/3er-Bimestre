 ...
 * Nombres: Kevin Audiel Solano Torres
 * proyecto:mapa
*/
...
#define PCF8574_LOW HIGH  //Negacion utilizada para encender un puerto del expansor PCF8574
#define PCF8574_HIGH LOW  //Negacion utilizada para apagar un puerto del expansor PCF8574
